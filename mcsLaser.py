...
def main():
    ...
    font = ('Aial',14)
    color = ('Blue')
    layout = [[sg.Text('Laserfiche Email Application v4.5.23', size=(30,1), font=font)],
              ...
              [sg.Text('*DocType: '), sg.OptionMenu(values=('INV','BOL','REC'),  size=(20 ,1), color=color, key='-DOCTYPE-')], #Choice of doctypes in db
